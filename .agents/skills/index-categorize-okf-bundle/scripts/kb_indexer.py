...
def create_kb_collection_index(input_dir, collection_name=None):
    ...
    index_md_lines = [
        ...
        "",
        "> [!NOTE]",
        "> This collection index was automatically generated by `.agents/skills/index-categorize-okf-bundle/scripts/kb_indexer.py`. All validated documents have been copied into this self-contained collection folder.",
        "",
        "## 📊 Collection Overview",
